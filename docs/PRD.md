...
```
Records processed         500 across 3 sources
Runtime                   8.4s cold

Auto-matched              412   (82.4%)
Rule-resolved              47   ( 9.4%)
Exceptions surfaced        41   ( 8.2%)
  └ collapsed into          6 root causes

Precision on auto-close   100%   (0 false auto-resolutions)
Recall vs ground truth   94.1%
Abstention rate           8.2%   (by design)

Human queue                 6 items, not 41
Workload reduction       98.8%   (6 of 500)
Cash at risk           ₹1.42L across 3 deadlines
GST input claimable    ₹1,815
```

Then the honest slide: **the four things it got wrong or refused to touch, and why.**
