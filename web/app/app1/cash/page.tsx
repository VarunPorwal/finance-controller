...
function CompactStrip({ bridge }: { bridge: NonNullable<ReturnType<typeof useCashBridge>["data"]> }) {
  ...
  const gapHref = unexplainedSeg?.exception_ids[0] ? `/app1/decisions?open=${unexplainedSeg.exception_ids[0]}` : undefined;
      ...
      {!runId && !runLoading && !error && (
        <div className="fc-card">
          <div className="flex flex-col items-center justify-center gap-2 px-6 py-14 text-center">
            ...
            <Link href="/app1/run" className="fc-btn mt-3 inline-flex items-center gap-1.5">
