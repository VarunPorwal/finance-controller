    ...
    <div className="fc-split">
      ...
      <FcCard className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1.5">
          <Link href="/app1/run" className="fc-btn fc-btn--ghost w-full justify-center">
            <Play size={13} />
            Run reconciliation
          </Link>
          <Link href="/app1/controller-activity#diff" className="fc-btn fc-btn--ghost w-full justify-center">
            <GitCompare size={13} />
            Replay and diff
          </Link>
