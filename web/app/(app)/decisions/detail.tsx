...
// is built directly with fc-card/fc-ev-* classes rather than the old app
// SlideOver, so this stays visually independent of pages still on the app
// theme.
  ...
  return (
    <Block title="What each source says" sub="The raw rows this exception is built from, from every file that carries the reference">
      ...
      <div className="mt-3 text-right">
        <a href="/records" className="fc-link">
          View in records →
        </a>
      </div>
    </Block>
