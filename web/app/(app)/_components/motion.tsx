    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          <motion.aside
            key="panel"
            className="app-pop fixed right-3 top-3 bottom-3 z-50 flex flex-col overflow-hidden"
          ...
          >
            {header ?? (
              <div className="flex items-start justify-between gap-4 border-b px-5 py-4">
                <div className="min-w-0">
                  <div className="app-h2 app-truncate">{title}</div>
            ...
            <div className="app-scroll min-h-0 flex-1" style={{ overscrollBehavior: "contain" }}>{children}</div>
  ...
  return (
    <span className="relative inline-flex" onMouseEnter={show} onMouseLeave={hide} onFocus={show} onBlur={hide} tabIndex={0}>
      ...
      <AnimatePresence>
        {open && (
          <motion.span
            className="app-pop pointer-events-none absolute left-1/2 z-50 w-max max-w-[260px] px-2.5 py-1.5 text-[11.5px] leading-snug"
