...
// One data layer for every app screen. All reads go through react-query on
// the generated client (CLAUDE.md: never hand-write fetch). Keys are prefixed
// "app" so they never collide with the other app's cache entries; the run
...
export function useRunSummary(runId: string | undefined, opts?: Q<RunSummary>) {
  return useQuery({
    queryKey: ["app", "run", runId, "summary"],
    enabled: !!runId,
    queryFn: async () =>
...
export function useRunDiff(fromRunId: string | undefined, toRunId: string | undefined) {
  return useQuery({
    queryKey: ["app", "diff", fromRunId, toRunId],
...
export function useExceptions(runId: string | undefined, opts?: Q<Exception[]>) {
  return useQuery({
    queryKey: ["app", "run", runId, "exceptions"],
    enabled: !!runId,
    queryFn: () =>
...
export function useEvidence(id: string | null) {
  return useQuery({
    queryKey: ["app", "exception", id, "evidence"],
    enabled: !!id,
    queryFn: async () =>
      need(
...
export function useClusters(runId: string | undefined) {
  return useQuery({
    queryKey: ["app", "run", runId, "clusters"],
    enabled: !!runId,
    queryFn: () =>
...
export function useCoverageCurve(runId: string | undefined) {
  return useQuery({
    queryKey: ["app", "run", runId, "coverage"],
    enabled: !!runId,
    retry: 0,
    queryFn: async () => {
...
export function useConfusion(runId: string | undefined) {
  return useQuery({
    queryKey: ["app", "run", runId, "confusion"],
    enabled: !!runId,
    retry: 0,
    queryFn: async () => {
...
export function useRuleVersions(ruleId: string | null) {
  return useQuery({
    queryKey: ["app", "rule", ruleId, "versions"],
    enabled: !!ruleId,
    queryFn: async () =>
      need(
...
export function useSuggestions() {
  return useQuery({
    queryKey: ["app", "rules", "suggestions"],
...
export function useEventsCount(runId: string | undefined) {
  return useQuery({
    queryKey: ["app", "run", runId, "events-count"],
    enabled: !!runId,
    queryFn: async () =>
...
export function useEvents(runId: string | undefined, filter: { source?: TransactionEvent["source"] } = {}) {
  return useQuery({
    queryKey: ["app", "run", runId, "events", filter],
    enabled: !!runId,
    queryFn: () =>
...
export function useMatches(runId: string | undefined) {
  return useQuery({
    queryKey: ["app", "run", runId, "matches"],
    enabled: !!runId,
    queryFn: () =>
...
export function useRawEvent(eventId: string | null) {
  return useQuery({
    queryKey: ["app", "event", eventId, "raw"],
    enabled: !!eventId,
    queryFn: async () =>
...
export function useLlmCalls(runId: string | undefined, limit = 50) {
  return useQuery({
    queryKey: ["app", "run", runId, "llm", limit],
    queryFn: async () =>
...
export function useNarrative(runId: string | undefined) {
  return useQuery({
    queryKey: ["app", "run", runId, "narrative"],
    enabled: !!runId,
    retry: 0,
    queryFn: async () => {
