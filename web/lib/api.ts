...
export interface paths {
    ...
    "/api/v1/settings/send-run-summary": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Send Run Summary
         * @description Email the run-complete summary for ``run_id`` (default: the newest
         ...
         */
        post: operations["send_run_summary_api_v1_settings_send_run_summary_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
    ...
    send_run_summary_api_v1_settings_send_run_summary_post: {
        parameters: {
            query?: {
                run_id?: string | null;
                dry_run?: boolean;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SendSummaryOut"];
                };
            };
            /** @description Validation Error */
            422: {
